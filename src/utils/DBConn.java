...
public class DBConn {
    private static String driver;//定义驱动
    private static String url;//定义URL
    private static String user;//定义用户名
    private static String password;//定义密码
    private static Connection conn;//定义连接
    ...
    static{
        try {
            ...
            System.out.println("-------Conn Sccuess------");
    ...
    public ResultSet doSelect(String sql) {
        try {
            ...
            System.out.println("Success get resultSet");
        } catch(SQLException sqlexception) {
